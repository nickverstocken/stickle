            ...
            <div class="intro">
                ...
                <div class="form">
                    <form id="frmRegister" method="POST" action="{{ route('register') }}" >
                        {{ csrf_field() }}
                        <input type="text" placeholder="Voornaam" name="firstname" value="{{ Auth::user()->firstname }}" required >
                        <input type="text" placeholder="Achternaam" name="lastname" value="{{ Auth::user()->lastname }}" required >
