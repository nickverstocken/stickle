            ...
            <div class="contentContainer">
                <form id="addBookForm" name="addBookForm" method="POST" enctype="multipart/form-data" action="/ouders/boeken/toevoegen">
                    ...
                    <div class="card">
                        ...
                        <input onchange="handleInputChange(event)"  type="file" name="bookCover" class="input">
                    </div>
                    <div class="card">
                        <h4>Titel</h4>
                        <input required name="title" type="text" class="input" placeholder="Boek titel*">
                    </div>
                    <div class="card">
                        <h4>Auteur</h4>
                    ...
                    <div class="card">
                        ...
                        <textarea required name="shortDescription" type="text" class="input" placeholder="Korte beschrijving*" class="input"></textarea>
                    </div>
                    <div class="card">
                        <h4>Aantal bladzijden</h4>
                        <input required name="numberOfPages" type="number" class="input" placeholder="Aantal bladzijden*">
                    </div> 
                </form>
                <div class="actions">
